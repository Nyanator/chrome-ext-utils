...
export interface CrossDispatcher<T extends ChannelMap> extends ChannelListenerMap<T> {
  /**
   * チャンネルに送信します。
...
@injectable()
export class CrossDispatcherImpl<T extends ChannelMap> implements CrossDispatcher<T> {
