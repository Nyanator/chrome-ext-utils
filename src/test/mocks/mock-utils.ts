...
export const mockAllSessionValues = () => {
    jest.spyOn(SessionStaticKey.prototype, "generateValue").mockResolvedValue(
        provideVedalue,
    );

    jest.spyOn(SessionStaticKey.prototype, "getValue").mockReturnValue(
        provideVedalue,
    );

    jest.spyOn(SessionStaticToken.prototype, "generateValue").mockResolvedValue(
        token,
    );
