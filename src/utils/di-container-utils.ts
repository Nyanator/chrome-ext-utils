...
import { MessageValidatorConfig, MessageValidatorImpl } from "../message-validator";
...
export const initializeDIContainer = (arg: {
  ...
  container.registerSingleton("MessageValidatorManager", MessageValidatorManagerImpl);
